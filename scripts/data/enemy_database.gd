...
const ENEMIES := {
	"normal": {
		...
		"ammo_drop_amount_min": 4,
		"ammo_drop_amount_max": 8,
	...
	"tank": {
		...
		"ammo_drop_chance": 0.45,
		"ammo_drop_amount_min": 6,
		"ammo_drop_amount_max": 12,
	...
	"exploder": {
		...
		"weapon_drop_weights": {},
		"ammo_drop_chance": 0.0,
		"ammo_drop_amount_min": 0,
		"ammo_drop_amount_max": 0,
	...
	"mini_boss": {
		...
		"ammo_drop_amount_min": 15,
		"ammo_drop_amount_max": 25,
	...
	"boss": {
		...
		"ammo_drop_chance": 1.0,
		"ammo_drop_amount_min": 30,
		"ammo_drop_amount_max": 50,
