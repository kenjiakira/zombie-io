...
const ENEMIES := {
	"normal": {
		...
		"weapon_drop_weights": {"pistol": 45, "smg": 25, "shotgun": 20, "revolver": 10},
	...
	"fast": {
		...
		"weapon_drop_weights": {"pistol": 15, "smg": 35, "shotgun": 25, "revolver": 15, "burst_rifle": 10},
	...
	"tank": {
		...
		"weapon_drop_weights": {"smg": 10, "shotgun": 25, "rifle": 25, "burst_rifle": 20, "minigun": 10, "sniper": 10},
	...
	"mini_boss": {
		...
		"weapon_drop_weights": {"shotgun": 25, "smg": 20, "rifle": 20, "burst_rifle": 15, "minigun": 10, "sniper": 10},
	...
	"boss": {
		...
		"attack_range": 48.0,
		"weapon_drop_chance": 1.0,
		"weapon_drop_weights": {"shotgun": 10, "smg": 15, "rifle": 20, "burst_rifle": 15, "minigun": 15, "sniper": 15, "laser_carbine": 10},
